...
namespace Game.Scripts.GamePlay
{
    public class SimulationManager : MonoBehaviour
    {
        ...
        [SerializeField] private float mutation_rate = 0.4f; // Сильно увеличиваем скорость мутации для более быстрого обучения
        [SerializeField] private float mutation_strength = 1.2f; // Значительно усиливаем мутации
        ...
        void Start()
        {
            ...
            // *********************************************************
            // ФИКСИМ ЗАГРУЗКУ: ПРОБУЕМ ЗАГРУЗИТЬ БЕЗ ВЫЛЕТА
            // *********************************************************
            Debug.Log("🧪 Пробуем загрузить сохраненную модель...");
            try {
                ...
                Debug.Log("⚠️ Начинаем обучение с нуля из-за ошибки загрузки.");
            }
